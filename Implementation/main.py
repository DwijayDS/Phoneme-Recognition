...
from Model_class.CNN_kernel3_gelu import MLP
...
validation_loader = DataLoader(validation_set,batch_size=test_batch_size,shuffle=True,num_workers=2)
...
PATH = '/scratch/shanbhag.d/Phoneme_Recognition/log/CNN_kernel3_gelu'+str(Context_length) +'Batch_'+str(256)
...
for epoch in range(epoch_start,epochs):
    ...
    for i,data in enumerate(train_loader):
        ...
        if i%2000 ==0:
            ...
            scheduler.step(running_val_loss/val_count)
