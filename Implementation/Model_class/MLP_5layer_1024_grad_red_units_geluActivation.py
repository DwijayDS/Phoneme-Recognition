...
class MLP(nn.Module):
    ...
    def __init__(self,Context_length):
        ...
        self.layer6 = nn.Linear(hid5,self.n_classes)
    ...
    def forward(self,x):
        ...
        x = self.layer6(x)   # We dont use activation here Because we are using cross entropy loss which has inbuild log softmax operation
