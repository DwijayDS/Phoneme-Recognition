# -*- coding: utf-8 -*-
"""
@title: Model Definition (5 Hidden Layer, Size (1024,512,512,256,128) gelu activation )
...
class MLP(nn.Module):
    ...
    def __init__(self,Context_length):
        ...
        self.layer9 = nn.Linear(hid8,self.n_classes)
    ...
    def forward(self,x):
        ...
        x = self.layer9(x)   # We dont use activation here Because we are using cross entropy loss which has inbuild log softmax operation
